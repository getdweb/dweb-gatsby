...
export default function Faq() {
  ...
  "data": {
    "allWordpressWpFaqSection": {
      "nodes": [
        {
          "id": "a1c3300d-162d-5ed5-9515-334d7a16fe24",
          "title": "DWeb meetups",
          "acf": {
            "questions": [
              {
        ...
        {
          "id": "3c3c7dbf-3c2d-5bd8-87c7-9bcb6d61fc6b",
    ...
    "wordpressAcfOptions": {
      "options": {
        "faq_header": "FAQ",
        "faq_bottom_text": "Have a question of your own?<br />Let us know via <a href=\\\"https://matrix.to/#/!WBhcGXTDMlzyTPWoJv:matrix.org?via=matrix.org&via=tomesh.net&via=privacytools.io\\\">community chat</a> or by emailing us at dweb [at] archive.org."
      }
    }
  }
}`)
  ...
  const sections = data.data.allWordpressWpFaqSection.nodes;
  let i = 0;
