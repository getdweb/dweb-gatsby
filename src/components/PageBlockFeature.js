...
export default function PageBlockFeature (props) {
    ...
    const button = fields.button_link_direction === 'internal'
        ...
        : <a href={fields.button_link_url} target="_blank" className="btn building-block__btn" rel="noreferrer">{fields.button_caption}</a>
                ...
                <div className="container">
                    <div className="row">
                        <div className="col">
                            ...
                            <div className="building-block__text" dangerouslySetInnerHTML={{__html: fields.text}} />
                            {button}
                        </div>
                    </div>
                </div>
